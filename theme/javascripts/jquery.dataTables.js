...
var oPreviousSearch = oSettings.oPreviousSearch;
        ...
        sSearchStr === "" ? '<input type="text" />' : ' <input type="text"  style="border:1px solid #CCC;" value="Ara" onclick="if(this.value == \'Ara\') { this.value = \'\';	}" onBlur="if(this.value == \'\') { this.value = \'Ara\';	}" />';
...
var oDefaults = DataTable.defaults.oLanguage;
        ...
        if (!oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
                oDefaults.sEmptyTable === "Result found in the query.")
{
...
if (!oLanguage.sLoadingRecords && oLanguage.sZeroRecords &&
        oDefaults.sLoadingRecords === "Wait...")
{
         ...
         */
                ...
                "aaData": null,
                        ...
                        "sSortAscending": ": activate to sort column ascending",
                                 ...
                                 *    } );
                                 */
                                "sEmptyTable": "Result found in the query",
                                /**
                                 ...
                                 *    } );
                                 */
                                "sInfo": "Showing _START_ , _END_ of total _TOTAL_",
                                /**
                                 ...
                                 *    } );
                                 */
                                "sInfoEmpty": "No results were found",
                                /**
