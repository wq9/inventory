        ...
        <div class="ten columns">
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="ten columns">
                        <label for="shelf"><?php lang('Product Serial'); ?></label>
                    ...
                    <?php if ($input_output == 'output') { ?>
                        <div class="ten columns">
                            <label for="customer_id"><?php lang('Customer ID'); ?></label>
                            <input type="text" name="customer_id" id="customer_id" class="" maxlength="50" minlength="3" placeholder="<?php lang('Customer ID'); ?>" />
                        </div>
                    <?php } ?>
