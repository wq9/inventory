        ...
        <form name="form_language" id="form_language" action="" method="POST">
            <fieldset>
                ...
                <select name="language" id="language">
                    <option value="english.php" <?php
                    if (get_meta('', '', 'settings', 'language') == 'english.php') {
                        echo 'selected';
                    }
                    ?>>english.php</option>
                    <option value="turkish.php" <?php
                    if (get_meta('', '', 'settings', 'language') == 'turkish.php') {
                        echo 'selected';
                    }
                    ?>>turkish.php</option>
                    <option value="spanish.php" <?php
                    if (get_meta('', '', 'settings', 'language') == 'spanish.php') {
                        echo 'selected';
                    }
                    ?>>spanish.php</option>
                </select>
