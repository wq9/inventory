...
<div class="row">
    <div class="four columns">
        ...
        if (isset($_POST['btn_add_user'])) {
            ...
            if (add_user($user_name, $password, $password_again, $email, $phone, $fax, $mobile, $level)) {
        ...
        <form name="form_login" id="form_login" action="?" method="POST">
            <fieldset>
                ...
                <input type="text" name="email" id="email" class="required" minlength="3" maxlength="100" />

                <label for="phone"><?php lang('Phone'); ?></label>
                <input type="text" name="Phone" id="Phone" class="" minlength="10" maxlength="11" />

                <label for="fax"><?php lang('Fax'); ?></label>
                <input type="text" name="fax" id="fax" class="" minlength="10" maxlength="20" />

                <label for="mobile"><?php lang('Mobile'); ?></label>
                <input type="text" name="mobile" id="mobile" class="" minlength="10" maxlength="20" />
